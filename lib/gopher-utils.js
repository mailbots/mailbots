...
module.exports = {
   ...
   *     Ex: Loading static pages, auth, etc.
   * ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
   */

  /**
   * Require login middleware.
   * Example: gopherApp.app.get('/route', requireLogin, (req, res) => {});
   * Sets up an authenticated insteance of Gopher API on res.locals.gopherClient
   * for use in events and middleware under gopher.api
  ...
  /**
   * Get an instance of the Gopher API client.
   */
  ...
  /**
   * Is the current request a webhook or normal http request?
   */
