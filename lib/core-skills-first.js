...
const debugAutoInit = require("debug")("mailbots:auto-init");
...
module.exports = function(mailbot) {
  ...
  function shouldAutoInit(config) {
    ...
    const shouldAutoInit = Date.now() - config.creationDate < MAX_AGE;
  ...
  function autoInit(config) {
    ...
    const requestOptions = {
      ...
      json: {
        ...
        install_url: config.mailbotUrl + "/auth/login",
        webhook_url: config.mailbotUrl + "/webhooks",
