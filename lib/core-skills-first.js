...
module.exports = function(gopherApp) {
  ...
  gopherApp.setErrorHandler((err, gopher) => {
    const errorMsg = `Gopher App caught an unhandled error. Please contact the extension developer. If you are the extension developer, use gopher.onError() to fail gracefully. View application logs for details.`;
