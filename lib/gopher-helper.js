    ...
    this.webhook = {
      ...
      getExtensionData: function(key, defaultValue) {
        if (key) {
          ...
          return this.get("extension.private_data");
        }
      },
      ...
      settingsForm: function({ namespace, title = "" }) {
        ...
        const settingsFormJSON = {
          JSONSchema: {
            ...
            type: "object",
            properties: {
              // filled in by form helpers
            }
          },
          uiSchema: {
            //filled in by by form helpers
          }
          // formData: settings
        };
        ...
        const formHelpers = {
          ...
          input: function({ name, title, description, helpText }) {
          ...
          textarea: function({ name, title, description, helpText }) {
            this.JSONSchema.properties[name] = {
              type: "string",
              title,
              description
          ...
          checkbox: function({ name, title, description, helpText }) {
            this.JSONSchema.properties[name] = {
              type: "boolean",
              title,
              description
