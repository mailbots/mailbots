 ...
 * response objects for each interaction. MailBot Skills (middleware)
 * add tools and features to this base object. Core Skills add
 * a MailBots API client and webhook helpers. MailBot developers
 * can append their skill to the bot.skills object to expose their
 * own middleware. By the time it is passed into an event handler
 * it's pretty talented little robot.
 */
...
class BotRequest {
  constructor(request, response) {
    ...
    /**
     * Developers use middleware to add / use MailBots' mad skillz. Ex: bot.skills.memorize();
     */
    this.skills = {};

    /**
     * Core middlware adds an instance of the MailBots API after the webhook has been validated;
     */
    this.api = {};
